...
BEGIN
    ...
    DBMS_SESSION.SET_CONTEXT('X_UNIVERITY_CONTEXT', 'USER_NAME', userId);
...
END;
/
DROP PROCEDURE SYS.SET_X_UNIVERITY_CONTEXT;
DROP TRIGGER SYS.SET_X_UNIVERITY_CONTEXT_TRIGGER;
COMMIT;